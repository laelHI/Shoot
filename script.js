    ...
    if (gameMode != 'gameOver'){
        ...
        for (let i = 0; i < arrows.length; i++) {
            ...
            if (arrow.stuck) {
                ...
                let angle = stump.rotate + arrow.angleOffset;
...
function shoot(){
    ...
    if (distance < stump.radius && !arrow.stuck){
        let hitAngle = Math.atan2(ydifference, xdifference) - stump.rotate;
